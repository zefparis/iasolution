    ...
    <section className="relative min-h-[60vh] flex items-center pt-32 pb-20 overflow-hidden">
      ...
      <Container className="relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            Une architecture moderne, sécurisée et performante. Backend Fastify 5, TypeScript strict, 
            PostgreSQL, Redis, et notre innovation exclusive : le Celestial Entropy Layer.
          </motion.p>
          ...
          >
            {["Fastify 5", "TypeScript", "PostgreSQL", "Redis", "Vitest", "Zod"].map((tech) => (
