...
const layers = [
  ...
  { level: "L6", name: "Post-Quantum Crypto", desc: "ML-DSA-65 (Dilithium) · ML-KEM-768 (Kyber) · NIST FIPS 204/203", icon: "🔮", color: "from-cyan-500/20 to-cyan-600/10", border: "border-cyan-500/30" },
  ...
  { level: "L3", name: "Anti-Replay Defense", desc: "Redis-atomic · Multi-instance safe · TTL 5min", icon: "🔄", color: "from-red-500/20 to-red-600/10", border: "border-red-500/30" },
  { level: "L2", name: "Cognitive Firewall", desc: "10 Signaux Fusion · Trust Graph · SCA PSD2", icon: "🧠", color: "from-purple-500/20 to-purple-600/10", border: "border-purple-500/30" },
